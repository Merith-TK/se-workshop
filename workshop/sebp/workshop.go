...
func extractWorkshopID(path string) string {
	...
	if metadata.ShipBlueprints.ShipBlueprint.WorkshopId != "" {
...
func fixWorkshopID(path string) string {
	...
	for i, item := range metadata.ShipBlueprints.ShipBlueprint.WorkshopIds {
		if item.WorkshopId.ServiceName == "Steam" {
			metadata.ShipBlueprints.ShipBlueprint.WorkshopIds[i].WorkshopId.ID = vdfItem.WorkshopID
			found = true
			break
		}
	}
	...
	if !found {
		metadata.ShipBlueprints.ShipBlueprint.WorkshopIds = append(metadata.ShipBlueprints.ShipBlueprint.WorkshopIds, shared.WorkshopIDItem{
			WorkshopId: struct {
